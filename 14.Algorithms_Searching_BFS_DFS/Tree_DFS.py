...
class BinarySearchTree:
    ...
    def traverse_in_order(self, node, lst):
        if node.left:
            self.traverse_in_order(node.left, lst)
        lst.append(node.value)
        if node.right:
            self.traverse_in_order(node.right, lst)
        return lst
    ...
    def traverse_post_order(self, node, lst):
        if node.left:
            self.traverse_post_order(node.left, lst)
        if node.right:
            self.traverse_post_order(node.right, lst)
        lst.append(node.value)
        return lst
